         ...
         <header>
            <div id="header_container" class="flexRow">
               <div id="logo_container" class="posRelative">
                  <img src="${pageContext.request.contextPath}/assets/images/logo/logo.png" alt="Johannes Fog logo">
            ...
            <div class="flexRow">
               <section id="customCarportNav_section" class="flexColumn">
                  ...
                  <div id="customCarportLinks_container">
                     ...
                     <div class="customCarportLink_container">
                        <a id="customCarportST_link" href="${pageContext.request.contextPath}/fc/customCarportST" class="customCarport_link">Carport med rejsning</a>
                     </div>
