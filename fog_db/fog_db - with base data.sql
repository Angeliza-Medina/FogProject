...
CREATE TABLE `screws` (
  ...
  `piecesPrPack` int NOT NULL,
  `price` double NOT NULL,
  `fk_unit_id` int NOT NULL,
  PRIMARY KEY (`screw_id`),
  UNIQUE KEY `screws_id_UNIQUE` (`screw_id`),
...
INSERT INTO `screws` VALUES (1,'Plastmo bundskruer',200,359,2),(2,'Skruer 4,50x60 mm',200,79.95,2),(3,'Beslagskruer 4,0x50 mm',250,249,2),(4,'Bræddebolt 10x120 mm',1,329,1),(5,'Skruer 4,5x70 mm',400,199,2),(6,'Skruer 4,5x50 mm',300,109,2);
...
CREATE TABLE `wood_connectors` (
  `wood_connector_id` int NOT NULL AUTO_INCREMENT,
  `productName` varchar(100) NOT NULL,
  `price` double NOT NULL,
  `fk_unit_id` int NOT NULL,
  PRIMARY KEY (`wood_connector_id`),
  UNIQUE KEY `idwood_connectors_UNIQUE` (`wood_connector_id`),
